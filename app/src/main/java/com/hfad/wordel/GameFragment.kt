...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val myWordFile = requireActivity().assets.open(WORD_FILE_NAME)

        if (viewModel.selectedWord == "") {
            viewModel.selectWord(myWordFile)
        }

        // Shows grid on createView
        showGrid(viewModel)
        ...
        binding.resetButton.setOnClickListener {
            viewModel.reset(requireActivity().assets.open(WORD_FILE_NAME))
            resetViews()
        }
    ...
    private fun updateGrid(turn: Int, correctList: List<Int>, userWord: String, viewModel: GameViewModel) {
        ...
        // Save grid colors in viewModel
        viewModel.saveGridColors(correctList, turn)

        // Save grid text in viewModel
    ...
    private fun showGrid(viewModel: GameViewModel) {
    ...
    private fun resetViews() {
        ...
        binding.correctLetters.text = ""
        binding.incorrectLetters.text = ""
